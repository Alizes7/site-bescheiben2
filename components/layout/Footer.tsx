        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2.5 mt-5">
              {[
                ...
                { href: "mailto:contato@bescheibenagency.com.br",  icon: Mail,         label: "Email" },
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/38">
              <li>
                <a href="mailto:contato@bescheibenagency.com.br" className="hover:text-white/75 transition-colors break-all">
                  contato@bescheibenagency.com.br
                </a>
              </li>
              <li>
                <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="hover:text-white/75 transition-colors">
                  WhatsApp
                </a>
              </li>
            </ul>
