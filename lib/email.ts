...
export async function sendContactEmail(data: ContactEmailData): Promise<boolean> {
  try {
    ...
    await resend.emails.send({
      from: "Bescheiben Site <noreply@bescheibenagency.com.br>",
      to: process.env.CONTACT_EMAIL || "contato@bescheibenagency.com.br",
...
export async function sendDiagnosticoEmail(data: DiagnosticoEmailData): Promise<boolean> {
  try {
    ...
    await resend.emails.send({
      from: "Bescheiben Digital Agency <noreply@bescheibenagency.com.br>",
      to: data.email,
