        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              {[
                { icon:Mail,         label:"Email",       value:"contato@bescheibenagency.com.br", href:"mailto:contato@bescheibenagency.com.br" },
                { icon:MessageSquare,label:"WhatsApp",    value:"Falar pelo WhatsApp",              href:"https://wa.me/5511999999999" },
